...
void initiateStartScreen(){
    ...
    readimagefile("images/background_dark.jpg",0,0,x,y);
...
void drawReadyButton(){
    ...
    if(turn%2==0){
        if(movedL==true)readimagefile("images/ready_btn_active.jpg",previewL1top,getmaxy()-latura,previewL1top+186,getmaxy()-latura+66);
        else if(movedL==false) readimagefile("images/ready_btn_waiting_move.jpg",previewL1top,getmaxy()-latura,previewL1top+186,getmaxy()-latura+66);
    readimagefile("images/ready_btn_inactive.jpg",previewL2top,getmaxy()-latura,previewL2top+186,getmaxy()-latura+66);
    }
    else{
    if(movedL)readimagefile("images/ready_btn_active.jpg",previewL2top,getmaxy()-latura,previewL2top+186,getmaxy()-latura+66);
    else readimagefile("images/ready_btn_waiting_move.jpg",previewL2top,getmaxy()-latura,previewL2top+186,getmaxy()-latura+66);
    readimagefile("images/ready_btn_inactive.jpg",previewL1top,getmaxy()-latura,previewL1top+186,getmaxy()-latura+66);
    }
}
void update(){
    char c;
