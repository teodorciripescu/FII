...
int main (int argc, char *argv[])
{
  ...
  if (sendto (sd, msg, 65507,0, (struct sockaddr*)&server, length) <= 0)
    {
  ...
  if ( (msglen=recvfrom (sd, msg, 65507,0,(struct sockaddr*)&server, &length)) < 0)
    {
